...
const Interview = () => {
    ...
    // Note: getReportById is already called by the useInterview hook's own useEffect
    // so we don't need a duplicate useEffect here
    ...
    // Safely default arrays in case the AI response is incomplete
